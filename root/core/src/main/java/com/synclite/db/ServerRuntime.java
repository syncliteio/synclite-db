...
final class ServerRuntime {
	...
	private static void initPaths() throws SQLException {
		...
		Path configuredDbDir = null;
		if (Main.dbConfigFilePath != null) {
			Path absoluteConfigPath = Main.dbConfigFilePath.toAbsolutePath();
			configuredDbDir = absoluteConfigPath.getParent();
		}

		Main.dbDir = configuredDbDir != null ? configuredDbDir : defaultDbDir;
		Main.stageDir = Main.dbDir.resolve("stageDir");
		try {
	...
	private static void dumpHeader() {
		...
		builder.append("\n");
		builder.append("db-root-directory : " + Main.dbDir);
		builder.append("\n");
		builder.append("trace-file : " + Main.dbDir.resolve("synclite_db.trace"));
		builder.append("\n");
		builder.append("========================================================================");
		builder.append("\n");
